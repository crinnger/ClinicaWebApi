...
@NoArgsConstructor
@AllArgsConstructor
public class ExameMedicoRequest implements Serializable {
	...
	@NotNull
	// @ApiParam(type = "String [11]", value = "CPF Válido com 11 digitos, Exemplo: 99999999999", example = "", required = true)
	private String cpfExamin2A;

	// @ApiParam(type = "String [11]", value = "CPF Válido com 11 digitos, Exemplo: 99999999999", example = "", required = false)
	private String cpfExamin3A;

	@NotNull
	/* @ApiParam(type = "char", value = "Exemplos: '1' 'APTO'\r\n" + "'2' 'APTO COM RESTRICOES'\r\n"
			+ "'4' 'INAPTO TEMPORARIO'\r\n" + "'5' 'INAPTO'\r\n"
			+ "'7' 'ENCAMINHAR JUNTA MEDICA'", example = "1", required = true)
	 */
	private char resultadoEmA;
...
//			+ "Observação: 'X' REFERE-SE À CATEGORIA ACC – AUTORIZACAO PARA CONDUZIR CICLOMOTOR (VEICULOS DE 2/3 RODAS ATÉ 59 CILINDRADAS)", example = "S", required = true)
	...
	@NotNull
	// @ApiParam(type = "String [88]", value = "Descrição: TEXTO PARA RESTRICAO CODIGO 'X' (OUTRAS RESTRICOES)", example = "", required = true)
	private String outrasRestricoes;

	@NotNull
	// @ApiParam(type = "char", value = "Descrição: VALOR EM ANOS (1,2 OU 3)", example = "1", required = true)
	private String revisaoMedicaA;

	@NotNull
	// @ApiParam(type = "char", value = "Descrição: VALOR EM ANOS (1,2 OU 3)", example = "1", required = true)
	private String revisaoOftalmoA;

	@NotNull
	// @ApiParam(type = "Int [3]", value = "Descrição: VALOR EM DIAS (1 A 365)", example = "365", required = true)
	private Integer periodoInaptidaoA;

	// @ApiParam(type = "String [30]", value = "Descrição: OBRIGATORIO QUANDO CATEGORIA = C,D OU E", example = "", required = false)
	private String numLaudoToxicologico;

	@NotNull
	// @ApiParam(type = "String [14]", value = "CNPJ Válido com 14 digitos, Exemplo: 99999999999999", example = "", required = true)
	private String cnpjLabA;
